...
let deviceId;
function useDeviceId(global2 = qq) {
...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__A3D72C8",
    appName: "ImitationBilibili",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initUni(api, protocols2, platform = qq) {
...
function callHook(name, args) {
  ...
  {
    if (name === "onLoad" && args && args.__id__ && isFunction(qq.getEventChannel)) {
...
qq.createSubpackageApp = global.createSubpackageApp = createSubpackageApp;
